...
class Visualization:
    ...
    def plot_not_normalized_data_sequence(self):
        ...
        num_cols = (len(self.plots_data) + num_rows - 1) // num_rows
        ...
        # Iterate over each baseline_type and plot the data in a subplot
        for i, (baseline_type, ax) in enumerate(zip(self.plots_data.keys(), axs)):
